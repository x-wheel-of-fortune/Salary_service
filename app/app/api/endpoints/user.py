...
def create_user(user_data: UserCreate, db: Session = Depends(get_db)):
    ...
    user = user_crud.create_user(db, username=user_data.username, email=user_data.email, password=user_data.password, salary=user_data.salary, promotion_date=user_data.promotion_date)
    return user
